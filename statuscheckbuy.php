...
if ($count > 0) {
    ...
    echo "<div class= 'alert alert-danger'><strong>[ERROR] </strong> :: Se ha ingresado una <strong><u>Orden de Compra</u></strong> que parece no estar registrada. Verificar Datos :: (error: JD03)</div>";
}   
