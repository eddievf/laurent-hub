...
<head>
	...
	<title>[PYMAQ] PDF - Consulta de Ordenes por Cliente</title>
...
<div class="container">
	<table width="100%" style="margin-bottom: 20px; border-bottom: 1px solid #CC6600; vertical-align: bottom; font-family: serif; font-size: 9pt; color: #000000;">
		<tr>
			...
			<td width="33%" align="center"><span style="font-family: Arial; color: #000000; font-weight: bold; font-size:16pt;">MAQUINADOS<br>Ordenes por Cliente</span></td>
...
<?php
	...
	$mpdf->Output('Cliente_'.$atwhat.'.pdf', 'I');
