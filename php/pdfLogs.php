...
<td width="33%" style="text-align: right; ">Consulta Personalizada</td>
...
<head>
	...
	<title>[PYMAQ] PDF - Bitácora de Actualización por Pieza - Maquinados</title>
...
<div class="container">
	<table width="100%" style="margin-bottom: 20px; border-bottom: 1px solid #CC6600; vertical-align: bottom; font-family: serif; font-size: 9pt; color: #000000;">
		<tr>
			...
			<td width="33%" align="center"><span style="font-family: Arial; color: #000000; font-weight: bold; font-size:16pt;">MAQUINADOS<br>Bitácora de Actualización por Pieza</span></td>
  ...
  <div class = "alert alert-info">
	<strong>INFO</strong> ::  Reporte actualizado hasta <strong><u> <?php echo $echofun; ?> </u></strong>
  </div>
</div>
