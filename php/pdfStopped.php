...
<head>
	...
	<title>[PYMAQ] PDF - Reporte de Ordenes con Pendientes</title>
...
<div class="container">
	<table width="100%" style="margin-bottom: 20px; border-bottom: 1px solid #CC6600; vertical-align: bottom; font-family: serif; font-size: 9pt; color: #000000;">
		<tr>
			...
			<td width="33%" align="center"><span style="font-family: Arial; color: #000000; font-weight: bold; font-size:16pt;">MAQUINADOS<br>Ordenes Detenidas por Pendientes</span></td>
...
<?php
	...
	$mpdf->Output('Detenidas_'.$atwhat.'.pdf', 'I');
}
else{
